...
function Address2() {
  return (
    <Base>
    <div className='mt-5 addBg container-fluid' style={{paddingLeft:"0%", paddingRight:"0%", marginLeft:"0%", marginRight:"0%"}}>
    ...
    <div className="container">
         <div className="row">
             <div className="col-6">
                ...
                <p className=' d-flex align-items-center justify-content-center'>HPJP+M6J, Blue Ridge Town Pune,<br/> Phase 1, Hinjewadi Rajiv Gandhi Infotech Park,<br/> Hinjawadi, Pimpri-Chinchwad, Maharashtra 411057</p>
             </div>
             <div className="col-6">
