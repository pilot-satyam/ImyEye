...
<Card className='border-0 shadow-sm  mt-5 my-2'>
      ...
      <br/>
      <CardTitle className='centerIt'> <h2>{prescription.user.name}</h2></CardTitle>
    <CardBody>
      ...
      <div>
        <Link className='btn btn-primary' to={'/prescriptions/'+prescription.id}>View Prescription</Link>
      </div>
        </CardText>
      <br/>
